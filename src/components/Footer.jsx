...
{/* 
 ...
 <div className="flex space-x-4">
              <Link 
                to="https://apps.apple.com/us/app/drizzy/id6752537717"
                id="google-play-footer"
              >
                <button className="inline-flex items-center px-6 py-3 rounded-lg bg-gray-800 text-white hover:bg-gray-700 transition-colors">
                  <img src="/AppStore.png" alt="Google Play" className="w-6 h-6 mr-2" />
                  <div className="text-left">
                    <div className="text-xs">GET IT ON</div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-4">
              ...
              >
                <div className="bg-gray-800 p-2 rounded-lg">
                  <img src="/linkedin-drizzy.png" alt="LinkedIn" className="w-6 h-6" />
                </div>
                <span>LinkedIn</span>
              </a>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <p className="text-center text-gray-400">
            © 2026 Drizzy. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
