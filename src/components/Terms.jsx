    ...
    <div className="bg-gray-100 min-h-screen py-10 px-6">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <p className="text-gray-600 mb-4">
          ...
          policy govern Drizzy's relationship with you in relation to
          this website or app.
        </p>

        <p className="text-gray-600 mb-4">
        The term 'Drizzy' or 'us' or 'we' refers to the owner of the website & app whose registered/operational office is Peace Co-Working, Kalkaji, Delhi – 110019. The term 'you' refers to the user or viewer of our website & app.
        </p>
        ...
        <ul className="list-decimal list-inside text-gray-600 space-y-3">
          ...
          <li>
            ...
            or document without Drizzy’s prior written consent.
          </li>
          <li>
