...
import { handleDownload } from './utils/DetectOs';
...
const Navbar = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-20">
          ...
          <div className="hidden md:flex flex-grow justify-center space-x-4 lg:space-x-8">
            <NavLink id="features-navbar" href="#features">Why Us</NavLink>
            <NavLink id="features-navbar" href="#Services">Services</NavLink>
          ...
          {/* App Store Buttons */}
          <div id="google-play-navbar" className="hidden md:flex items-center justify-end flex-shrink-0 ml-4 lg:ml-8 gap-2">
          <Link to={"https://apps.apple.com/app/drizzy/id6752537717"}>
  ...
  className="px-4 lg:px-6 py-2 lg:py-3 rounded-lg bg-gray-900 text-white hover:bg-gray-800 hover:cursor-pointer transition-colors">
  Download App
</button>
        ...
        <div className={`md:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="px-2 pt-2 pb-3 space-y-4">
            <a href="#features" className="block px-3 py-2 text-black hover:bg-yellow-100 rounded-lg text-center">Why Us</a>
            <a href="#Services" className="block px-3 py-2 text-black hover:bg-yellow-100 rounded-lg text-center">Services</a>
