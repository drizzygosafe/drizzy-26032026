        ...
        <div className="flex flex-col lg:flex-row items-center justify-between py-12 md:py-20 lg:py-32">
          ...
          <section className="flex-1 text-center lg:text-left mb-12 lg:mb-0 z-10 w-full lg:w-1/2 px-4 md:px-8">
            ...
            <p className="text-gray-700 text-lg md:text-xl lg:text-2xl mb-8 max-w-xl mx-auto lg:mx-0">
             “Book your driving lessons with certified instructors easier and quicker than making your Maggi. Start your journey to becoming a confident and safe driver today.”
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              {/* <ChatButton /> */}
                ...
                <button
                  id="hero-download"
                  className="border-2 border-black bg-yellow-500 text-black px-8 py-4 rounded-full font-semibold text-lg md:text-xl hover:bg-black hover:text-white transition-colors w-full sm:w-auto"
