    ...
    <div className="bg-gray-100 min-h-screen py-10 px-6">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <p className="text-gray-600 mb-4">
          Drizzy believes in helping its customers as far as possible and has therefore adopted a liberal cancellation policy. Under this policy:
        </p>
        ...
        <ul className="list-decimal list-inside text-gray-600 space-y-4">
          ...
          <li>
            In case of any <span className="font-semibold">Refunds</span> approved by Drizzy, the refunded amount will be credited to your bank account within <span className="font-semibold">6-8 working days</span>.
          </li>
          <li>
