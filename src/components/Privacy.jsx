              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded-md shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-black">
                    ...
                    Drizzy Trainer or RRS & Co. or Drizzy.
                  </p>
                  <p className="text-black">
                    <span className="text-yellow-600 font-semibold">
                      Company
                    ...
                    this Agreement) refers to RRS & Co. (Drizzy), Peace Co-Working, Kalkaji, Delhi – 110019. 
                  </p>
                  <p className="text-black">
                    <span className="text-yellow-600 font-semibold">
                      Cookies
                  ...
                  <p className="text-black">
                    ...
                    refers to RRS & Co. (Drizzy), accessible from
...
You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="bg-white p-4 rounded-md shadow-sm">
              ...
              <p><span className="text-yellow-600 font-semibold">By Mail:</span> Peace Co-Working, Kalkaji, Delhi – 110019</p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="bg-white p-4 rounded-md shadow-sm">
                ...
                <p className="mb-2">
                  ...
                  drizzy.gosafe@gmail.com & +91 11 79663728
                </p>
                <p>
                  <span className="text-yellow-600 font-semibold">
                    By Mail:
                  </span>{" "}
                  Peace Co-Working, Kalkaji, Delhi – 110019
                </p>
              </div>
            </div>
          </div>
